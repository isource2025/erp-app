...
interface PagosData {
  detalle: { ano: number; mes: number; concepto: string; total_pagado: number; cantidad: number }[];
...
export default function PagosPage() {
  ...
  const totalGeneral = data?.totalesMensuales.reduce((s, r) => s + r.total_pagado, 0) || 0;
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Estadísticas de pagos realizados</p>
      </div>
